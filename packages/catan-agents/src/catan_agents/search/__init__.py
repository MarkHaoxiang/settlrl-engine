...
player count: they receive a censored state + belief, determinize it with one
``sample_world`` draw, and search in the sample (PIMC — the simulated
opponents share the sampled world).
"""
