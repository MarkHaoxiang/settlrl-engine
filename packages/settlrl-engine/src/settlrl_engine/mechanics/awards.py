...
:mod:`settlrl_engine.mechanics.longest_road`; this module turns per-player
...
from settlrl_engine.board.layout import MAX_VERTEX_DEGREE, N_EDGES, N_VERTICES
...
from settlrl_engine.mechanics.longest_road import (
    ADJ_DEG,
    ADJ_EDGE,
    ADJ_INDPTR,
    longest_road_length,
