...
from settlrl_engine.board.resources import N_PLAYERS, N_RESOURCES, PlayerResourcesArray

# Per-player building stock (standard Settlrl).
MAX_ROADS = 15
MAX_SETTLEMENTS = 5
MAX_CITIES = 4
...
class BoardState(NamedTuple):
    ...
    total is needed (see settlrl_engine.mechanics.action.player_total_vp).
