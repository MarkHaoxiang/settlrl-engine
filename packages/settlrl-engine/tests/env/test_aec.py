"""Tests for the PettingZoo-AEC wrapper (settlrl_engine.env.aec).
...
from settlrl_engine.env.aec import SettlrlAECEnv, env
from settlrl_engine.mechanics.action import ActionType
from settlrl_engine.mechanics.flat import FLAT_ATYPE, FLAT_IDX, flat_available_b
...
class TestSettlrlAEC:
    ...
    def test_two_player_mode(self) -> None:
        ...
        e = SettlrlAECEnv(seed=8, n_players=2)
...
class TestDiscardOneCard:
    ...
    @staticmethod
    def _force_discard(e: SettlrlAECEnv) -> None:
