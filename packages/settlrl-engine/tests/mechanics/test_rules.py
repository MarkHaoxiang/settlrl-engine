...
oracle (the ``settlrl-reference`` package, via ``tests.conversion``) across
randomized boards."""
...
from settlrl_engine.board.state import MAX_ROADS, BoardState, make_board_state
from settlrl_engine.mechanics import common, dice, longest_road, trade
...
# on a Settlrl board (MAX_VERTEX_DEGREE = 3); the dumbbell is its closest
# realizable analogue.
