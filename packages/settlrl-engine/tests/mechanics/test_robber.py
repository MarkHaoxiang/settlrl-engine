"""Tests for robber.py: the victim mask (equivalence vs the `settlrl-reference` oracle) and
...
from settlrl_engine.board.state import BoardState, make_board_state
from settlrl_engine.mechanics import robber
