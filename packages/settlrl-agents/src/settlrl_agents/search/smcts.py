...
from settlrl_engine.mechanics.action import ActionType, apply_action
...
from settlrl_agents.search.mcts import (
    _ILLEGAL,
    _NO_PROPOSE,
    _QTRANSFORM,
    _ROLL_P,
...
def make_smcts(
    ...
    *,
    ...
    Same ensemble semantics as :func:`~settlrl_agents.search.mcts.make_mcts`
